...
namespace LadaEngine
{
	public class SpotLight
	{
		...
		public iPos resolution = new iPos(1024, 1024);
		...
		public SpotLight(Vector4 color, Vector4 position)
		{
			...
			this.color = color;
			CreateTextures();
			lightSprite = new Sprite(resultRenderDiffuse, StandartShaders.GenStandartShader());
		}

		public void Render(Pos cam)
		{
		...
		private void CreateTextures()
		{
			...
			GL.BindImageTexture(0, resultRenderDiffuse.Handle, 0, false, 0, TextureAccess.WriteOnly,
			...
			GL.BindImageTexture(0, resultRenderNormal.Handle, 0, false, 0, TextureAccess.WriteOnly,
				SizedInternalFormat.Rgba32f);
